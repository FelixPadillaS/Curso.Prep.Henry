...
function crearUsuario() { // 1
  ...
  // El `constructor` debe tener un método llamado "saludar" en su `prototype` que 
...
function agregarMetodoPrototype(Constructor) { // 2
...
function agregarStringInvertida() { // 3
...
// 4--------------------------------------------------------------------------//
  ...
  class Persona { 
    constructor (nombre, apellido, edad, domicilio) {/*Escribir los argumentos que recibe 
      //el constructor*/
      // Crea el constructor:
      this.nombre = nombre,
...
function crearInstanciaPersona(nombre, apellido, edad, dir) { // 5
